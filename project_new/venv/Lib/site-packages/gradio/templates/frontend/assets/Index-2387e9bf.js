import { B as Block } from './Button-20c14f3f.js';
import { u as uploadToHuggingFace, c as copy } from './utils-8f25e669.js';
import { d as dequal } from './index-21d69e4c.js';
import { S as ShareButton } from './ShareButton-4c59f811.js';
import { S as Static } from './Index-34f70ab5.js';
import { r as resolve_wasm_src } from './file-url-9a71ec36.js';
import { I as Image } from './Image-81c44f01.js';
import { V as Video } from './Video-227d44f6.js';
import './Index.svelte_svelte_type_style_lang-900e0c31.js';
import { M as MarkdownCode } from './Example.svelte_svelte_type_style_lang-0e22497a.js';
import { g as get_fetchable_url_or_file, n as normalise_file } from './index-6d9f7a14.js';
import { C as Check } from './Check-f7edb5d9.js';
import { C as Copy } from './Copy-a69620a8.js';
import { B as BlockLabel } from './BlockLabel-01d2e4bc.js';
import './IconButton-7a2ae610.js';
...
// (75:0) {#if show_share_button && value !== null && value.length > 0}
function create_if_block_12(ctx) {
	...
	sharebutton.$on("error", /*error_handler*/ ctx[22]);
	sharebutton.$on("share", /*share_handler*/ ctx[23]);

	return {
		c() {
			div_1 = element$1("div");
			create_component$1(sharebutton.$$.fragment);
			attr$1(div_1, "class", "share-button svelte-13uw1ey");
		},
		m(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			attr$1(button, "aria-label", button_aria_label_value = (/*j*/ ctx[41] == 0 ? "user" : "bot") + "'s message: " + (typeof /*message*/ ctx[39] === "string"
			? /*message*/ ctx[39]
			: `a file of type ${/*message*/ ctx[39].file?.mime_type}, ${/*message*/ ctx[39].file?.alt_text ?? /*message*/ ctx[39].file?.orig_name ?? ""}`));

			attr$1(button, "class", "svelte-13uw1ey");
			...
			attr$1(div0, "class", "message " + (/*j*/ ctx[41] == 0 ? 'user' : 'bot') + " svelte-13uw1ey");
			...
			attr$1(div1, "class", div1_class_value = "message-row " + /*layout*/ ctx[16] + " " + (/*j*/ ctx[41] == 0 ? 'user-row' : 'bot-row') + " svelte-13uw1ey");
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (!current || dirty[0] & /*value*/ 1 && button_aria_label_value !== (button_aria_label_value = (/*j*/ ctx[41] == 0 ? "user" : "bot") + "'s message: " + (typeof /*message*/ ctx[39] === "string"
			? /*message*/ ctx[39]
			: `a file of type ${/*message*/ ctx[39].file?.mime_type}, ${/*message*/ ctx[39].file?.alt_text ?? /*message*/ ctx[39].file?.orig_name ?? ""}`))) {
			...
			if (!current || dirty[0] & /*layout*/ 65536 && div1_class_value !== (div1_class_value = "message-row " + /*layout*/ ctx[16] + " " + (/*j*/ ctx[41] == 0 ? 'user-row' : 'bot-row') + " svelte-13uw1ey")) {
...
function create_if_block_11(ctx) {
	...
	image = new Image({
			props: {
				class: "avatar-image",
				src: get_fetchable_url_or_file(/*avatar_images*/ ctx[8][/*j*/ ctx[41]], /*root*/ ctx[13], /*proxy_url*/ ctx[14]),
				alt: "" + ((/*j*/ ctx[41] == 0 ? 'user' : 'bot') + " avatar")
			}
		});
	...
	return {
		c() {
			...
			attr$1(div_1, "class", "avatar-container svelte-13uw1ey");
		},
		m(target, anchor) {
			insert$1(target, div_1, anchor);
		...
		p(ctx, dirty) {
			const image_changes = {};
			if (dirty[0] & /*avatar_images, root, proxy_url*/ 24832) image_changes.src = get_fetchable_url_or_file(/*avatar_images*/ ctx[8][/*j*/ ctx[41]], /*root*/ ctx[13], /*proxy_url*/ ctx[14]);
...
function create_if_block_9(ctx) {
	...
	image = new Image({
			props: {
				...
				src: /*message*/ ctx[39].file?.url,
				alt: /*message*/ ctx[39].alt_text
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			const image_changes = {};
			if (dirty[0] & /*value*/ 1) image_changes.src = /*message*/ ctx[39].file?.url;
			if (dirty[0] & /*value*/ 1) image_changes.alt = /*message*/ ctx[39].alt_text;
			image.$set(image_changes);
		},
		i(local) {
			if (current) return;
...
function create_if_block_8(ctx) {
	...
	video.$on("play", /*play_handler_1*/ ctx[27]);
	video.$on("pause", /*pause_handler_1*/ ctx[28]);
	video.$on("ended", /*ended_handler_1*/ ctx[29]);
	...
	return {
		...
		p(ctx, dirty) {
			const video_changes = {};
			if (dirty[0] & /*value*/ 1) video_changes.src = /*message*/ ctx[39].file?.url;
			if (dirty[0] & /*value*/ 1) video_changes.title = /*message*/ ctx[39].alt_text;
...
function create_if_block_7(ctx) {
	...
	audio.$on("play", /*play_handler*/ ctx[24]);
	audio.$on("pause", /*pause_handler*/ ctx[25]);
	audio.$on("ended", /*ended_handler*/ ctx[26]);
	...
	return {
		...
		p(ctx, dirty) {
			const audio_changes = {};
			if (dirty[0] & /*value*/ 1) audio_changes.src = /*message*/ ctx[39].file?.url;
			if (dirty[0] & /*value*/ 1) audio_changes.title = /*message*/ ctx[39].alt_text;
...
// (146:9) {#if typeof message === "string"}
...
// (167:10) <Video            data-testid="chatbot-video"            controls            src={message.file?.url}            title={message.alt_text}            preload="auto"            on:play            on:pause            on:ended           >
function create_default_slot$1(ctx) {
	...
	return {
		c() {
			...
			attr$1(track, "class", "svelte-13uw1ey");
		},
		m(target, anchor) {
...
// (199:7) {#if (likeable && j !== 0) || (show_copy_button && message && typeof message === "string")}
function create_if_block_3(ctx) {
	...
	return {
		c() {
			...
			t = space$1();
			if (if_block1) if_block1.c();
			attr$1(div_1, "class", div_1_class_value = "message-buttons-" + (/*j*/ ctx[41] == 0 ? 'user' : 'bot') + " message-buttons-" + /*layout*/ ctx[16] + " " + (/*avatar_images*/ ctx[8][/*j*/ ctx[41]] !== null && 'with-avatar') + " svelte-13uw1ey");
		...
		p(ctx, dirty) {
			...
			if (!current || dirty[0] & /*layout, avatar_images*/ 65792 && div_1_class_value !== (div_1_class_value = "message-buttons-" + (/*j*/ ctx[41] == 0 ? 'user' : 'bot') + " message-buttons-" + /*layout*/ ctx[16] + " " + (/*avatar_images*/ ctx[8][/*j*/ ctx[41]] !== null && 'with-avatar') + " svelte-13uw1ey")) {
...
// (215:9) {#if show_copy_button && message && typeof message === "string"}
...
// (97:4) {#each message_pair as message, j}
...
// (96:3) {#each value as message_pair, i}
...
//# sourceMappingURL=Index-2387e9bf.js.map
