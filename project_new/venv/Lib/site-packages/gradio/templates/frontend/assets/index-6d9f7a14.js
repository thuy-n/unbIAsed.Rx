...
const ENTRY_CSS = "./assets/index-ec560a49.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-34f70ab5.js').then(n => n.I),true?["./Index-34f70ab5.js","./Index-2497c410.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-6d9f7a14.js.map
